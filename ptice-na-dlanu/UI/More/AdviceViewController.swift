...
extension AdviceViewController: AdviceDelegate {
    func toggleAdvice(_ row: Int) {
        ...
        tableView.scrollToRow(at: IndexPath.init(row: row, section: 1), at: .top, animated: false)
    }
